...
server <- function(input, output) {
  ...
  output$network <- renderPlot({
    ...
    type_path = paste('./analysis/gigtran-gene-binorm/', as.character(type), sep='')
    ...
    type_net_node = read.csv('./analysis/gigtran-gene-binorm/t2ds_layer_new_average_fold_node_weight_df.csv')
